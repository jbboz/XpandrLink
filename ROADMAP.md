...
Standalone builds and runs on Windows 11, hardware-validated against both synths; VST3 compiles without admin rights and is now built-and-loaded-in-a-DAW validated too (TEST-PLAN Session E, closed).
