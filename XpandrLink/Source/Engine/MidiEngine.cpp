...
//
// A "Get Patch" dump request does NOT reflect front-panel mod-matrix edits on real
// hardware -- live capture proved the dump always returns stale mod-matrix bytes no
// matter how long you wait after an edit. So this decodes the edit message directly
// instead of requesting a resync dump, matching the C# reference's
// HandleModulationEditFromSynth (XpanderController.MIDIEvents.cs).
